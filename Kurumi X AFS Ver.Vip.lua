...
local window = library:new({textsize = 13.5,font = Enum.Font.RobotoMono,name = "Kurumi X AFS",color = Color3.fromRGB(255,0,255)})

window:watermark({name = 'Snow Hub V2 | Free Only | Version 2.0.2 | https://discord.gg/3BD4daxgpS'})

local Main = window:page({name = "Main"})

local Main_1_left = Main:section({name = "Dupe",side = "left",size = 450})

Main_1_left:button({name = "Start Dataloss",callback = function()
local args = {
...
Notification.new("success", "Success Heading", "Success  Start Dataloss Machine.")
end})

Main_1_left:button({name = "Rejoin",callback = function()
game:GetService'TeleportService':TeleportToPlaceInstance(game.PlaceId,game.JobId,game:GetService'Players'.LocalPlayer)
end})

Main_1_left:textbox({name = "Put JobId",def = "Id",placeholder = "Textbox",callback = function(value)
  _G.ID = value
end})
...
spawn(function()
      while task.wait() do
        pcall(function()
          if _G.JOBJOIN then
          local pid = 6299805723; -- place id
game:GetService("TeleportService"):TeleportToPlaceInstance(pid,(tostring(_G.ID)), game.Players.LocalPlayer)
end
            end)
        end
end)
...
Main_1_left:toggle({name = "Join JobId",def = false,callback = function(GGG)
_G.JOBJOIN = GGG
end})

Main_1_left:button({name = "Copy JobId",callback = function()
setclipboard(game.JobId)
end})

Main_1_left:button({name = "Empty Server",callback = function()
...
TPS:TeleportToPlaceInstance(_place,Server.id,game.Players.LocalPlayer)      local Http = game:GetService("HttpService")
local TPS = game:GetService("TeleportService")
local Api = "https://games.roblox.com/v1/games/"
...
local Main_1_right = Main:section({name = "Machine",side = "right",size = 450})

Main_1_right:button({name = "Dataloss Machine",callback = function()
  								local Notification = loadstring(game:HttpGet("https://raw.githubusercontent.com/Jxereas/UI-Libraries/main/notification_gui_library.lua", true))()
