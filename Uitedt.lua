...
shared.LoaderTitle = 'Kurumi Hub' -- ใส่ชื่อ
...
Core:Destroy()
    ...
    local foldername = "Kurumi X"
    local filename = "AFS "..game.Players.LocalPlayer.Name.." Config.json"
...
ImageButton1.Image = "http://www.roblox.com/asset/?id=13186299760"
